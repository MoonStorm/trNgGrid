    ...
    */
    ...
    angular.module("trNgGrid", []).directive(tableDirective, [function () {
        ...
        function ($templateCache) {
            ...
            $templateCache.put(TrNgGrid.cellHeaderTemplateId, '<div class="' + TrNgGrid.columnContentsCssClass + '">' + '  <div ng-if="!columnOptions.isCustomized">' + '    <div class="' + TrNgGrid.columnTitleCssClass + '">' + '      {{displayName |' + TrNgGrid.columnTitleDisplayNameFilter + ':fieldName}}' + '       <div ' + TrNgGrid.columnSortDirectiveAttribute + ' />' + '    </div>' + '    <div ' + TrNgGrid.columnFilterDirectiveAttribute + '/>' + '  </div>' + '  <div ng-if="columnOptions.isCustomized">' + '    <div ng-transclude/>' + '  </div>' + '</div>');
