...
module TrNgGrid {
    ...
    export function fixGridSection(
        ...
        for (var rowIndex = 0; rowIndex < rowElements.length; rowIndex++) {
            ...
            // ensure the auto-fill elements are there
            if (cellElements.length === 0 || !cellElements[0].attr(Constants.dataColumnIsAutoGeneratedAttribute)) {
    ...
    export function fixTableStructure(
        ...
        fixGridSection(gridConfiguration, tableHeaderElement, Constants.headerRowDirectiveAttribute, "th", Constants.cellHeaderDirectiveAttribute);
