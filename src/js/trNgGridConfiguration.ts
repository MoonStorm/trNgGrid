module TrNgGrid {
    ...
    class GridConfigurationDefaultTemplates implements IGridTemplates {
        ...
        constructor($interpolateProvider: ng.IInterpolateProvider, gridStyles: IGridStyles) {
            ...
            this.headerCellStandard =
                '<th></th>';

            this.headerCellContentsStandard =
                '<div>'
                + '  <div ' + Constants.columnSortDirectiveAttribute + '=""></div>'
                ...
                + '      '+startNgSymbol+'gridColumnOptions.columnTitle |' + Constants.translateFilter + ':gridOptions.locale'+endNgSymbol
                + '  </a>'
                + '  <div ' + Constants.columnFilterDirectiveAttribute + '=""></div>'
                + '</div>';

            this.bodyCellStandard =
                '<td></td>';

            this.bodyCellContentsStandard =
                '<div>'
                + '  '+startNgSymbol+'gridDisplayItem[columnOptions.displayFieldName]'+endNgSymbol+'</div>'
                + '</div>';

            this.footerCellStandard =
