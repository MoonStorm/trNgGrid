...
module TrNgGrid {
    ...
    class GridConfigurationDefaultTemplates implements IGridTemplates {
        ...
        constructor($interpolateProvider: ng.IInterpolateProvider, gridStyles: IGridStyles) {
            ...
            //this.cellHeaderAuto =
            //    '<th' +
            //    ' data-ng-repeat="autoGridColumnLayoutOptions in gridLayoutRowColumns"' +
            //    ' ' + 'data-ng-if="autoGridColumnLayoutOptions.isAutoGenerated"' +
            //    ' ' + 'data-field-name="'+startNgSymbol+'autoGridColumnLayoutOptions.fieldName'+endNgSymbol+'"' +
            ...
            this.headerCellContentsStandard =
                ...
                + '      '+startNgSymbol+'gridColumnOptions.columnTitle |' + TrNgGrid.Constants.translateFilter + ':gridOptions.locale'+endNgSymbol
                + '  </a>'
