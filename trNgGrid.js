...
(function (TrNgGrid) {
    ...
    var GridConfigurationDefaultTemplates = (function () {
        function GridConfigurationDefaultTemplates($interpolateProvider, gridStyles) {
            ...
            this.cellHeaderAuto = '<th' + ' data-ng-repeat="autoColumn in gridRowColumns" data-field-name="{{autoColumn.fieldName}}"' + ' ' + TrNgGrid.Constants.cellHeaderDirectiveAttribute + '="" ' + ' ' + TrNgGrid.Constants.dataColumnIsAutoGeneratedAttribute + '="true">' + '</th>';
            this.cellHeaderStandard = '<div class="' + gridStyles.headerCellCssClass + '" >' + '  <div ' + TrNgGrid.Constants.columnSortDirectiveAttribute + '=""></div>' + '  <a ' + gridStyles.columnTitleCssClass + '"' + '     href="" ng-click="((gridOptions.enableSorting&&gridColumnOptions.enableSorting!==false)||gridColumnOptions.enableSorting)&&toggleSorting(gridColumnOptions.fieldName)">' + '      {{gridColumnOptions.columnTitle |' + TrNgGrid.Constants.translateFilter + ':gridOptions.locale}}' + '  </a>' + '  <div ' + TrNgGrid.Constants.columnFilterDirectiveAttribute + '=""></div>' + '</div>';
