...
(function (TrNgGrid) {
    ...
    var GridConfigurationDefaultTemplates = (function () {
        function GridConfigurationDefaultTemplates($interpolateProvider, gridStyles) {
            ...
            this.cellHeaderAuto = '<th' + ' data-ng-repeat="autoGridColumnLayoutOptions in gridLayoutRowColumns"' + ' ' + 'data-ng-if="autoGridColumnLayoutOptions.isAutoGenerated"' + ' ' + 'data-field-name="' + startNgSymbol + 'autoGridColumnLayoutOptions.fieldName' + endNgSymbol + '"' + ' ' + TrNgGrid.Constants.cellHeaderDirectiveAttribute + '="" ' + ' ' + TrNgGrid.Constants.dataColumnIsAutoGeneratedAttribute + '="true">' + '</th>';
